      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10 space-y-6">
          ...
          <div className="text-center space-y-3 pb-2">
            <h1 className="text-6xl md:text-5xl font-bold text-gray-900 pt-2 pb-3">
              Welcome Back
            </h1>
            <p className="text-base md:text-lg text-gray-600 px-2 pb-1">
          ...
          {/* Sign Up Link */}
          <p className="text-center text-sm md:text-base text-gray-600 pt-2 pb-1">
